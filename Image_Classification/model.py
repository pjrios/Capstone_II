...
from torchvision.models import swin_b, EfficientNet_V2_L_Weights
from torchvision.models import Swin_B_Weights, efficientnet_v2_l
...
for filename in os.listdir(folder_path):
    if filename.endswith("jpg"): 
        if cnt < 100:
            ...
            break
print('Total images with solar panel: ',len(panels))
...
sw = efficientnet_v2_l(weights=EfficientNet_V2_L_Weights.DEFAULT, progress=False)

# Initailze tranforms (default)
preprocess_img = EfficientNet_V2_L_Weights.DEFAULT.transforms()
...
categories = EfficientNet_V2_L_Weights.DEFAULT.meta["categories"]
